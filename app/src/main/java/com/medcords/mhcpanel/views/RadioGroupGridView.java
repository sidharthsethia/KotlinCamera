...
/**
 * Created by sidharthsethia on 13/02/17.
 */
...
public class RadioGroupGridView extends TableLayout implements View.OnClickListener {
     ...
     * @param context
     */
    public RadioGroupGridView(Context context) {
        super(context);
     ...
     * @param attrs
     */
    public RadioGroupGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
    }
